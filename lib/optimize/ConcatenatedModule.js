...
class HarmonyConcatenatedTemplate extends DependencyTemplate {
	constructor(originalTemplate) {
		super();
		this.originalTemplate = originalTemplate;
	}

	apply(dep, source, runtimeTemplate, dependencyTemplates) {
		if (this.useOriginalTemplate(dep)) {
	...
	useOriginalTemplate(dep) {
		throw new Error("useOriginalTemplate must be overriden");
	}
}

class HarmonyImportSpecifierDependencyConcatenatedTemplate extends HarmonyConcatenatedTemplate {
...
class HarmonyImportSideEffectDependencyConcatenatedTemplate extends HarmonyConcatenatedTemplate {
	constructor(originalTemplate, modulesMap) {
		super(originalTemplate);
		this.modulesMap = modulesMap;
	}
...
class HarmonyExportSpecifierDependencyConcatenatedTemplate extends HarmonyConcatenatedTemplate {
	...
	useOriginalTemplate(dep) {
		return dep.originModule === this.rootModule;
	}
}
...
class HarmonyExportImportedSpecifierDependencyConcatenatedTemplate extends HarmonyConcatenatedTemplate {
